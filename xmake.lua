...
target("OSF Animation")
    ...
    before_build(function (target)
        ...
        table.join2(inputs, { path.join(ui, "package.json"), path.join(ui, "package-lock.json"),
                              path.join(ui, "osfui.config.ts"), path.join(ui, "osfui.mock.json"),
    ...
    after_build(function (target)
        ...
        if mods then
            ...
            os.tryrm(path.join(views, "osf.animation"))
            os.tryrm(path.join(views, "assets"))
            os.tryrm(path.join(views, "shared"))
            os.mkdir(views)
